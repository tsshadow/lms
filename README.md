...
2.  **SSH**: Set `REMOTE_HOST`, `REMOTE_USER`, etc. The script will SSH into the host, stop the old container, and start a new one. This method is better if you want to manage everything via files on the server.
