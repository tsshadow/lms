...
<nav class="p-6 flex flex-col gap-6 h-full">
  ...
  <div class="library">
    ...
    <ul class="list-none p-0 m-0">
      ...
      <li><button class="w-full px-3 py-2 bg-transparent border-none {activeView === 'starred' ? 'text-white' : 'text-[#b3b3b3]'} text-sm font-medium cursor-pointer transition-colors hover:text-white text-left" onclick={() => navigate('starred')}>Favorieten</button></li>
    </ul>
  </div>
