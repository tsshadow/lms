...
When a user sets a rating for a track (via the MuMa Spotify interface, Subsonic API, or any other interface), the `MusicManagement` feedback backend catches the event and forwards it to a configured webhook.
