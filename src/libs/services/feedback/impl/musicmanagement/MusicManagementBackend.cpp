...
namespace lms::feedback::musicManagement
{
    MusicManagementBackend::MusicManagementBackend(boost::asio::io_context& ioContext, db::IDb& db)
        ...
        , _db{ db }
        , _apiUrl{ core::Service<core::IConfig>::get()->getString("music-management-rating-api-url", std::string{ core::Service<core::IConfig>::get()->getString("music-management", "https://muma-rating-service.teunschriks.nl") } + "/rating/api/lms-event") }
        , _apiKey{ core::Service<core::IConfig>::get()->getString("music-management-rating-api-key", core::Service<core::IConfig>::get()->getString("music-management-api-key", core::Service<core::IConfig>::get()->getString("api-key", "Scouring-Quiver2-Throat-Everyday-Economist-Squabble"))) }
    {
