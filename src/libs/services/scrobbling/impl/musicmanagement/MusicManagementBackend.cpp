...
namespace lms::scrobbling::musicManagement
{
    MusicManagementBackend::MusicManagementBackend(boost::asio::io_context& ioContext, db::IDb& db)
        ...
        , _apiKey{ core::Service<core::IConfig>::get()->getString("music-management-scrobbling-api-key", core::Service<core::IConfig>::get()->getString("muma-api-key", "453ecd33-3cb2-4ca4-a531-1677330bbaee")) }
    {
        if (!_apiUrl.empty())
        {
